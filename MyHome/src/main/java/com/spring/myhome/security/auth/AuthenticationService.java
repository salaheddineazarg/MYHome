...
import com.spring.myhome.entities.Token;
import com.spring.myhome.entities.User;
import com.spring.myhome.enumeration.TokenType;
import com.spring.myhome.repository.TokenRepository;
import com.spring.myhome.repository.UserRepository;
import com.spring.myhome.security.jwt.JwtService;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(UserDto request) {
        ...
        return AuthenticationResponse.builder()
                ...
                .user(modelMapper.map(savedUser, UserDtoResponse.class))
                .build();
    }
